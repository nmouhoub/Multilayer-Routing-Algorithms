...
typedef pair<pair<pair<pair<pair<int,int>,AdaptationFunction*>,int>,int>,int> Row;
...
class RoutingTable
{
	...
	public:
		...
		bool add_route(int dest, string protocol_stack, int cost, int next_hop, AdaptationFunction *adapt_func, int h_max, int hops, int i);
};
